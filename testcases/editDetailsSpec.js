...
describe('Navigate to Admin tab and check General info', function() {
  ...
  it('should navigate to General Information page and edit Details', function(){
    OrganizationPage.clickEditandSaveButton();
    OrganizationPage.fillOrganizationName(testData.organizationName);
    OrganizationPage.filltaxId(testData.taxId);
    OrganizationPage.fillregistrationNumber(testData.registrationNumber);
    OrganizationPage.fillfaxNumber(testData.faxNumber);
    OrganizationPage.clickEditandSaveButton();
